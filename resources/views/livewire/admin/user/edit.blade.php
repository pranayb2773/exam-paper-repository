<div>
    <div class="space-y-4 mx-auto h-full w-full px-4 md:px-6 lg:px-8 max-w-7xl">
        ...
        <x-breadcrumbs.main>
            ...
            <x-breadcrumbs.link>{{ $user->name }}</x-breadcrumbs.link>
        ...
        <header class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <!-- Page Title -->
            <div>
                <h1 class="text-2xl sm:text-3xl tracking-tight font-bold text-secondary-900 dark:text-secondary-100">{{ __('Edit') . ' ' . $user->name  }}</h1>
            </div>
                                    ...
                                    <div class="p-6">
                                        <div class="grid gap-6 grid-cols-1 lg:grid-cols-2">
                                            <div class="col-span-2 lg:col-span-1">
                                                ...
                                                <x-input.text wire:model.blur="user.name" id="name"
                                                              class="w-full mt-1" field="user.name"></x-input.text>
                                            </div>
                                            <div class="col-span-2 lg:col-span-1">
